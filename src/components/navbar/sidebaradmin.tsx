...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  return (
    <div
      className={`fixed inset-0 flex lg:hidden transition-opacity duration-300 ${
        ...
        <ul className="space-y-4">
          <li>
            <Link
              ...
              className="flex items-center text-white hover:text-blue-300 py-2 px-4 rounded transition-colors duration-300"
              onClick={toggleSidebar}
            >
